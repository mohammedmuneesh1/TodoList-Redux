...
export default function TodoTask() {
  ...
  const edittaskfn=(e,EID,editedvalue)=>{
    ...
    setShowedit(null);  //should pass as an object {id:EID,title:editedvalue}
    // dispatch(edittask())
           ...
           {showedit!==value.id ? (        //comparing with value.id is to make the edit field unique to select and edit 
             <>
               ...
               <div className="editicon" style={{ display: "flex" }}>
                 ...
                 <button className="delete-button" onClick={()=>dispatch(deletetask(value.id))}>
             ...
             <>
               ...
               <input type="text" className="editinput"  defaultValue={value.title}   ref={EIref} /> &nbsp;&nbsp;&nbsp;&nbsp;
                 
 
                 <div className="editicon" style={{ display: "flex" }}>
                   <button className="btnCloud" onClick={(e)=>edittaskfn(e,value.id,EIref.current.value)}>
                     <svg
